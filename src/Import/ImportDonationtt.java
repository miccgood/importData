 ...
 * @author tanet-t
 */
public class ImportDonationtt extends ImportData{
...
//    private static final String DEPARTMENT_CODE = "09"; 
    ...
    public ImportDonationtt() {
        super(START_ROW_DONAION);
        ShFormType formType = dao.findShFormTypeByFormTypeCode(FORM_TYPE_CODE_DONATOR);
        if(formType != null){
...
//            setErrorValue(86, DEPARTMENT_CODE);
        ...
        Date birthDate = getDateCellValueNoSetError(cell17); // วันเดือนปีเกิด
...
//        
    ...
    private void addPersonDoc(XSSFRow row, ShPerson person) {
        ...
        Date expireDate = getDateCellValueNoSetError(cell15);
